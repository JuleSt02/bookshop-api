...
export const findBooksByUserController =  async (req:Request, res:Response, next: NextFunction) => {
     

    const prismaBookRepository = new PrismaBookRepository();
    const userRepository = new PrismaUserRepository();
    const findBooksByUserUseCase = new FindBooksByUserUseCase(prismaBookRepository, userRepository)
